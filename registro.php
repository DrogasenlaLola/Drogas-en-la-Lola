...
if(!$connection) 
        ...
        $instruccion_SQL = "INSERT INTO registro(nombre, edad, email, contraseña)
                             VALUES ('$nombre','$edad','$email','$contraseña')";
...
mysqli_close( $connection );
   ...
   //echo "Fuera " ;
   echo'<a href="index.html"> registro completo, volver al index</a>';
